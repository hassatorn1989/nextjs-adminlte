    ...
    render() {
        return (
            <aside className="main-sidebar sidebar-dark-primary elevation-4">
                {/* Brand Logo */}
                <a href="./static/index3.html" className="brand-link">
         ...
         with font-awesome or any other icon font library */}
              ...
              <i className="right fas fa-angle-left" />
                                ...
                                <ul className="nav nav-treeview">
                                    <li className="nav-item">
                                        <a href="./static/index.html" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Dashboard v1</p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="./static/index2.html" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Dashboard v2</p>
                                        </a>
                                    </li>
                                    <li className="nav-item">
                                        <a href="./static/index3.html" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Dashboard v3</p>
                                        </a>
                                    </li>
              ...
              <i className="fas fa-angle-left right" />
                                ...
                                <ul className="nav nav-treeview">
                                    ...
                                    <li className="nav-item">
                                        <a href="./static/starter.html" className="nav-link">
                                            <i className="far fa-circle nav-icon" />
                                            <p>Starter Page</p>
                                        </a>
                                    </li>
